...
@Document
class Player(@Id val playerId: String, val login: String, val password: String, var wallet: Int, var leagueId: String?, var characters: ArrayList<Character>?, var fights: ArrayList<Fight>?)